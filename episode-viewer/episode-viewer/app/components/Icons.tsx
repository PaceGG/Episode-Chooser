      ...
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g id="Calendar / Timer">
            ...
            <path
              id="Vector"
              d="M 12 9 V 13 L 16 13 M 10 2 H 14 M 12 21 C 7.5817 21 4 17.4183 4 13 C 4 8.5817 7.5817 5 12 5 C 16.4183 5 20 8.5817 20 13 C 20 17.4183 16.4183 21 12 21 Z"
              stroke={props.color}
              stroke-width="1.3"
              stroke-linecap="round"
              stroke-linejoin="round"
